...
#' @description Using a expression matrix, calculates the mean and the coefficient of variation to the probeset or genes using only the cases samples or control samples or using all the samples.
...
#' @return A data frame with the expression matrix and two new colums. one to the mean and the another one to the coefficient of variation values.
