...
The analysis of biological data through network approach have gone increase in the last years due to the capacity of this approach to analyze a high number of information in a simple way and the fact that exist a variety of biological networks to create and analyzed depending of the data obtained by the researcher (protein-protein interaction, signed interaction networks, gene regulation networks, among others). Currently, one of the most useful kind of biological network are the co-expression network. As usual, this kind of network are created from expression measures and consider the existence of particular relations of expression among diferente genes, proteins or RNA fragments involved in the develpment or arise of a specific phenotype. Here, we present coexnet, a new R package to the construction of undirected co-expression networks from microarray data obtained from GEO Datasets database. This package all the necessary functions to download, normalize and filter expression data to finally create a co-expression network unsing correlation measures as statistic approach. 
